...
def make_tuples(input_data):
    ...
    for line in input_data[1:]:
        ...
        url = 'https://nu.primo.exlibrisgroup.com/discovery/search?query=any,contains,' + \
              line[2] + '&tab=Everything&search_scope=MyInst_and_CI&vid=01NATIONAL_INST:NATL&lang=en&mode=basic&pcAvailability=false'
